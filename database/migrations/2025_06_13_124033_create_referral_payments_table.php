...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('referral_payments', function (Blueprint $table) {
            ...
            $table->unsignedInteger('referral_payments_referral_id')->nullable();
            ...
            $table->unsignedInteger('referral_payments_created_by')->nullable();
            $table->unsignedInteger('referral_payments_updated_by')->nullable();
