...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('employee', function (Blueprint $table) {
            ...
            $table->integer('employee_title')->nullable();
            $table->string('employee_first_name', 255)->nullable();
            $table->string('employee_surname', 255)->nullable();
            ...
            $table->string('employee_email_address', 255)->nullable();
            ...
            $table->string('employee_username', 255)->nullable();
            ...
            $table->foreign('employee_annual_leave_accrual_method', 'fk_employee_employee_annual_leave_accrual_method')
                ->references('annual_leave_accrual_method_id')->on('annual_leave_accrual_methods')
                ->onUpdate('cascade')->onDelete('restrict');
        });
    }
