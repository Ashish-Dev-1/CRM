...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('vendor', function (Blueprint $table) {
            ...
            $table->integer('vendor_title')->nullable();
            ...
            $table->unsignedBigInteger('vendor_status')->nullable();
            ...
            $table->integer('vendor_sole_sale_fee_type')->nullable();
            $table->decimal('vendor_multi_sale_fee', 7, 2)->nullable();
            $table->integer('vendor_multi_sale_fee_type')->nullable();
