...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('tenancy', function (Blueprint $table) {
            ...
            $table->integer('tenancy_type')->nullable();
            $table->unsignedInteger('tenancy_property')->nullable();
            ...
            $table->unsignedTinyInteger('tenancy_rent_vat_rate')->nullable();
            ...
            $table->unsignedTinyInteger('tenancy_service_charge_vat_rate')->nullable();
            ...
            $table->unsignedTinyInteger('tenancy_insurance_vat_rate')->nullable();
            ...
            $table->unsignedTinyInteger('tenancy_letting_service')->nullable();
            $table->decimal('tenancy_tenant_find_fee', 10, 2)->nullable();
            $table->integer('tenancy_tenant_find_fee_type')->nullable();
            $table->decimal('tenancy_management_fee', 10, 2)->nullable();
            $table->integer('tenancy_management_fee_type')->nullable();
            ...
            $table->integer('tenancy_tenant_find_with_management_fee_type')->nullable();
...
$table->foreign('tenancy_renewal_status', 'fk_tenancy_tenancy_renewal_status')
    ...
    ->onUpdate('cascade')->onDelete('restrict');
$table->foreign('tenancy_is_renewal_id', 'fk_tenancy_tenancy_is_renewal_id')
