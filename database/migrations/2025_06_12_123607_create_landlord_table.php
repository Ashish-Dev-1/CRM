...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('landlord', function (Blueprint $table) {
            ...
            $table->integer('landlord_type')->nullable();
            $table->integer('landlord_title')->nullable();
            ...
            $table->string('landlord_company_name', 255)->nullable();
            ...
            $table->string('landlord_fax', 255)->nullable();
            $table->string('landlord_email', 255)->nullable();
            $table->string('landlord_email_accounts', 255)->nullable();
            $table->string('landlord_email_works', 255)->nullable();
            $table->string('landlord_property_number_name', 50)->nullable();
            $table->string('landlord_apartment_number_name', 50)->nullable();
            $table->string('landlord_address_line_1', 255)->nullable();
            $table->string('landlord_address_line_2', 255)->nullable();
            ...
            $table->string('landlord_bank_account_name', 100)->nullable();
            $table->string('landlord_bank_iban', 50)->nullable();
            $table->string('landlord_bank_bic_swift', 11)->nullable();
            $table->unsignedInteger('landlord_nrl_status')->nullable();
            ...
            $table->unsignedInteger('landlord_status')->nullable();
